...
def get_model():
	...
	lstm_q = LSTM(rnn_dim, dropout=0.2, recurrent_dropout=0.2, return_sequences=True, go_backwards=False)
	lstm_a = LSTM(rnn_dim, dropout=0.2, recurrent_dropout=0.2, return_sequences=True, go_backwards=False)
	encoded_ques = lstm_q(question)
	encoded_ans = lstm_a(answer)
	lstm_q = LSTM(rnn_dim, dropout=0.2, recurrent_dropout=0.2, go_backwards=False)
	lstm_a = LSTM(rnn_dim, dropout=0.2, recurrent_dropout=0.2, go_backwards=False)
	encoded_ques = lstm_q(encoded_ques)
	encoded_ans = lstm_a(encoded_ans)
