...
def get_model():
	...
	shared_lstm = LSTM(rnn_dim, dropout=0.2, recurrent_dropout=0.2, return_sequences=True, go_backwards=False)
	encoded_ques = shared_lstm(question)
	encoded_ans = shared_lstm(answer)
	shared_lstm = LSTM(rnn_dim, dropout=0.2, recurrent_dropout=0.2, go_backwards=False)
